...
@SupportedAnnotationTypes({"io.github.tivrfoa.mapresultset.api.Column", "io.github.tivrfoa.mapresultset.api.Table",
		"io.github.tivrfoa.mapresultset.api.Query", "io.github.tivrfoa.mapresultset.api.Id",
		"io.github.tivrfoa.mapresultset.api.OneToOne", "io.github.tivrfoa.mapresultset.api.OneToMany",
		"io.github.tivrfoa.mapresultset.api.ManyToOne", "io.github.tivrfoa.mapresultset.api.ManyToMany"})
		...
		for ( TypeElement annotation : annotations ) {
			...
			for (var e : annotatedElements) {
				...
				switch (annotation.toString()) {
					case "io.github.tivrfoa.mapresultset.api.Column":
						processColumn(elementName, e);
					break;
					case "io.github.tivrfoa.mapresultset.api.Table":
						processTable(elementName, e);
						break;
					case "io.github.tivrfoa.mapresultset.api.Query":
						processQuery(elementName, e);
						break;
					case "io.github.tivrfoa.mapresultset.api.OneToOne":
						addRelationship(elementName, e, Relationship.Type.OneToOne);
						break;
					case "io.github.tivrfoa.mapresultset.api.OneToMany":
						addRelationship(elementName, e, Relationship.Type.OneToMany);
						addCreationAndAddMethods(elementName, e);
						break;
					case "io.github.tivrfoa.mapresultset.api.ManyToOne":
						addRelationship(elementName, e, Relationship.Type.ManyToOne);
						break;
					case "io.github.tivrfoa.mapresultset.api.ManyToMany":
						addRelationship(elementName, e, Relationship.Type.ManyToMany);
						addCreationAndAddMethods(elementName, e);
						break;
					case "io.github.tivrfoa.mapresultset.api.Id":
